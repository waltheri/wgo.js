...
exports.markupProperties = exports.SGFwriters = exports.SGFreaders = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _WGo = require("../WGo");

var _WGo2 = _interopRequireDefault(_WGo);

var _SGFParser = require("./SGFParser");

var _SGFParser2 = _interopRequireDefault(_SGFParser);
...
var moveSGFReaderFactory = function moveSGFReaderFactory(color) {
...
var setupSGFReaderFactory = function setupSGFReaderFactory(color, propIdent) {
	return function (node, value) {
		if (value == null) {
...
var markupSGFReaderFactory = function markupSGFReaderFactory(type) {
	return function (node, value) {
		if (value == null) {
...
var playerInfoSGFReaderFactory = function playerInfoSGFReaderFactory(color, type) {
	return function (node, value) {
...
var gameInfoSGFReaderFactory = function gameInfoSGFReaderFactory(property) {
	return function (node, value) {
		node.gameInfo = node.gameInfo || {};
 ...
 */
var SGFreaders = exports.SGFreaders = {
	B: moveSGFReaderFactory(_WGo2.default.B),
	W: moveSGFReaderFactory(_WGo2.default.W),
	AB: setupSGFReaderFactory(_WGo2.default.B, "AB"),
	AW: setupSGFReaderFactory(_WGo2.default.W, "AW"),
	AE: setupSGFReaderFactory(_WGo2.default.E, "AE"),
	PL: function PL(node, value) {
		if (value) {
			if (value[0] == "b" || value[0] == "B") node.setTurn(_WGo2.default.B);else if (value[0] == "w" || value[0] == "W") node.setTurn(_WGo2.default.W);
		} else {
			node.setTurn();
		}
	},
 ...
 */
var SGFwriters = exports.SGFwriters = {
 ...
 */
var markupProperties = exports.markupProperties = ["CR", "LB", "MA", "SL", "SQ", "TR"];
...
var KNode = function () {
	_createClass(KNode, null, [{
		...
		value: function fromSGF(sgf, ind) {
			var parser = new _SGFParser2.default(sgf);
			return KNode.fromJSGF(parser.parseCollection()[ind || 0]);
		}
	}]);

	function KNode() {
		_classCallCheck(this, KNode);
  ...
  */
   ...
   */
		...
		value: function setSGFProperty(propIdent, propValue) {
			if (typeof propValue == "string") {
				var parser = new _SGFParser2.default(propValue);
   ...
   */
		...
		value: function setSGF(sgf) {
			...
			// prepare parser
			var parser = typeof sgf == "string" ? new _SGFParser2.default(sgf) : sgf;
			...
			if (parser.currentChar == ";") {
				...
				// syntax error
				throw new _SGFParser2.default.SGFSyntaxError("Illegal character in SGF node", parser);
			}
		}
   ...
   */
		...
		value: function addSetup(setup) {
			...
			for (var i = 0, property; i < setup.length; i++) {
				...
				if (setup[i].c == _WGo2.default.B) property = "AB";else if (setup[i].c == _WGo2.default.W) property = "AW";else property = "AE";
		...
		value: function setMove(move) {
			...
			} else if (move.c == _WGo2.default.W) {
				delete this.SGFProperties.B;
		...
		value: function getTurn() {
			if (this.turn) return this.turn;else if (this.move) return -this.move.c;else if (this.parent) return this.parent.getTurn();else return _WGo2.default.B;
		}
	}, {
		key: "setComment",
