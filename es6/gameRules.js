...
var gameRules = {
	_default: JAPANESE_RULES
}

gameRules["Japanese"] = JAPANESE_RULES;
gameRules["GOE"] = gameRules["NZ"] = ING_RULES;
gameRules["AGA"] = gameRules["Chinese"] = CHINESE_RULES;
gameRules["None"] = NO_RULES;
