...
c.parent=this;this.children=[c];return c},appendChild:function(c){c.parent=this;this.children.push(c);return c},getProperties:function(){var c={},a;for(a in this)this.hasOwnProperty(a)&&"children"!=a&&"parent"!=a&&(c[a]=this[a]);return c}};b.KNode=r;var y=function(c,a){for(var e=c.size,h=[],d=[],b=0;b<e*e;b++)c.schema[b]&&!a.schema[b]?d.push({x:Math.floor(b/e),y:b%e}):c.schema[b]!=a.schema[b]&&h.push({x:Math.floor(b/e),y:b%e,c:a.schema[b]});return{add:h,remove:d}},e=function(c,a,e){this.kifu=c;this.node=
this.kifu.root;this.allow_illegal=e||!1;this.game=new b.Game(this.kifu.size,this.allow_illegal?"NONE":"KO",this.allow_illegal,this.allow_illegal);this.path={m:0};this.kifu.info.HA&&1<this.kifu.info.HA&&(this.game.turn=b.W);this.change=v(this.game,this.node,!0);this.rememberPath=a?!0:!1},w=function(c,a){var e=[],h,d;for(d in c){h=!0;for(var b in a)if(c[d].x==a[b].x&&c[d].y==a[b].y){h=!1;break}h&&e.push(c[d])}return e},v=function(c,a,e){a.parent&&(a.parent._last_selected=a.parent.children.indexOf(a));
...
y:c.node.children[e].move.y,c:"rgba(0,32,128,0.8)"});if(c.node.markup){for(e in c.node.markup)for(var d=0;d<a.length;d++)c.node.markup[e].x==a[d].x&&c.node.markup[e].y==a[d].y&&(a.splice(d,1),d--);a=a.concat(c.node.markup)}this.temp_marks=a;this.board.addObject(a)},l=function(c){this.board.setSize(c.kifu.size);this.board.removeAllObjects();this.config.enableWheel&&this.setWheel(!0)},d=function(c,a){return c==a.element||c==a.element?!1:c._wgo_scrollable||c.scrollHeight>c.offsetHeight?!0:d(c.parentNode,
...
return!this.config.lockScroll},h=function(a,e){if(!this.kifuReader||!this.kifuReader.node)return!1;for(var d in this.kifuReader.node.children)if(this.kifuReader.node.children[d].move&&this.kifuReader.node.children[d].move.x==a&&this.kifuReader.node.children[d].move.y==e){this.next(d);break}},n=function(a){this.config=a;for(var e in n.default)void 0===this.config[e]&&void 0!==n.default[e]&&(this.config[e]=n.default[e]);this.element=document.createElement("div");this.board=new b.Board(this.element,
